 ...
 * @classname: b12简易内存池_200_区间问题区间交集
 * @desc: Todo
 ...
 * @version: V-1.0
 */
public class b12简易内存池_200_区间问题区间交集 {
    ...
    // 判断两个区间是否存在交集
    private static boolean hasIntersection(Integer[] range1, Integer[] range2) {
        int s1 = range1[0];
        int e1 = range1[1];
